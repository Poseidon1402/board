...
export const NavigationBar = () => {
  ...
  return (
    <nav>
      <div className="absolute flex h-24 w-full items-center justify-between px-8">
      ...
      <div
        className={`flex h-screen flex-col gap-8 bg-background px-8 py-12 transition-transform duration-300 ${expanded ? "translate-x-0" : "translate-x-full"}`}
      >
